...
//
// Halaman detail LENGKAP + cetak sebuah Pengajuan Voucher Petty Cash - mirror
// arsitektur purchase-order/[id]/page.tsx (PrintablePO) & persis
// petty-cash/pengajuan/[id]/page.tsx: tombol Cetak menunggu logo company
// ready (waitForLogoReady, lib/companyDetails.ts) lalu window.print() lewat
// double requestAnimationFrame, dan blok `.print-only` dirender DI LUAR
// <Content> (Card) - kalau dinest di dalamnya, border/shadow/padding Card
// ikut ke-print (lihat komentar sama persis di file PO). Dibuat sebagai
// halaman terpisah (bukan print dari dalam Dialog) karena pola print-only
// ini butuh hidup di luar wrapper Dialog/Card.
...
import { fetchVoucherById } from "@/services/pettyCashVoucherService";
