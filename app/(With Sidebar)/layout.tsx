  ...
  return (
    <>
      <SidebarProvider>
        ...
        <AppSidebar className="shadow-lg no-print" />
        <SidebarInset>
          <header className="no-print flex h-16 shrink-0 items-center gap-2 transition-[width,height] ease-linear group-has-data-[collapsible=icon]/sidebar-wrapper:h-12">
